...
class BigQueryMCPServer:
    ...
    def __init__(self, config_dict: dict = None):
        ...
        self.config = BigQueryServerConfig(config_dict=config_dict or {})
...
server = BigQueryMCPServer(config_dict={})
...
async def health_check(request: Request):
    ...
    try:
        ...
        datasets = list(server.client.list_datasets(max_results=1))
        ...
        return JSONResponse(
            {
                ...
                "project_id": server.config_data.get("project_id"),
                "auth_method": server.config_data.get(
